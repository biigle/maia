<refine-candidates-tab :selected-candidates="selectedCandidates" :label-trees="labelTrees" v-on:select="handleSelectedLabel" inline-template>
<div class="sidebar-tab__content sidebar-tab__content--maia">
    ...
    <div class="maia-tab-content__bottom">
        ...
        <button class="btn btn-success btn-block" disabled>Convert annotation candidates</button>
    </div>
</div>
