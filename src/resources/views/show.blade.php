...
<div id="maia-show-container" class="sidebar-container" v-cloak>
    <div class="sidebar-container__content">
        ...
        @if ($job->shouldShowTrainingProposals())
            @if ($job->state_id->value >= \Biigle\Modules\Maia\MaiaJobState::TRAINING_PROPOSALS->value)
            ...
            @endif
        @endif
        @if ($job->state_id->value >= \Biigle\Modules\Maia\MaiaJobState::ANNOTATION_CANDIDATES->value)
    ...
    <sidebar v-bind:open-tab="openTab" v-on:open="handleTabOpened">
        ...
        @if ($job->shouldShowTrainingProposals())
            @if ($job->state_id === \Biigle\Modules\Maia\MaiaJobState::TRAINING_PROPOSALS)
            ...
            @endif
        @endif
        @if ($job->state_id === \Biigle\Modules\Maia\MaiaJobState::ANNOTATION_CANDIDATES)
